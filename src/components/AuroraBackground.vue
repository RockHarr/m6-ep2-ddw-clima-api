...
<script setup>
/**
 * AuroraBackground — Efecto aurora boreal animado con WebGL.
 * Portado de vue-bits (DavidHDev/vue-bits) a JavaScript puro.
 * Requiere la dependencia: ogl
 */
import { onMounted, onUnmounted, watch, useTemplateRef } from 'vue'
import { Renderer, Program, Mesh, Color, Triangle } from 'ogl'

const props = defineProps({
  colorStops: { type: Array, default: () => ['#1a1a2e', '#4361ee', '#06d6a0'] },
...
function initAurora() {
  ...
  const update = (t) => {
    ...
    if (program) {
      ...
      const stops = props.colorStops ?? ['#1a1a2e', '#4361ee', '#06d6a0']
